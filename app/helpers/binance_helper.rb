...
#			end
			...
			tale = PurchaseTale.create!(symbol_name: state.symbol_name, price: price, buy_id: order[:orderId], buy_complete: true, asset_quantity: order[:executedQty], state_snapshot: state.as_json.except!("_id"))
